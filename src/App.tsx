...
const fetchCompletions = (userInput: string) =>
    fetch("/api/generate", {
        method: "POST",
        headers: {
            ...
            <main className="w-full flex items-center justify-center">
                <div className="max-w-2xl mt-20">
                    ...
                    <p className="mt-4 text-lg text-gray-800">
                        Learn how to efficiently manage your codebase and master
                        the power of version control by translating plain
                        English into Git commands.
                    </p>
